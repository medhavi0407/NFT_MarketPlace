  ...
  return (
    <Section>
      <div className="title">
        ...
        <p>
          This is your marketplace where all the transactions take place.
          All the operations like creating,buying and selling happen in NFT market places.
        </p>
      </div>
        ...
        {marketPlaceData.map(({ image, name }) => {
          return (
            <div className="marketplace">
              ...
              <h6 className="username">@medhavisaxena</h6>
